return function()
	...
	local icons = { dap = require("pure-nvim.utils.icons").get("dap") }
	local colors = require("pure-nvim.utils").get_palette()
	...
	require("pure-nvim.utils").load_plugin("mason-nvim-dap", {
		ensure_installed = require("pure-nvim.core.settings").mason_dap_adapters,
