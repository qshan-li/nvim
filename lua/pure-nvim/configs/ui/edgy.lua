return function()
	...
	require("pure-nvim.utils").load_plugin("edgy", {
		...
		left = {
			{
				...
				pinned = true,
				collapsed = false,
				size = { height = 1, width = 0.15 },
				open = function()
					return vim.b.buftype == "" and "Trouble symbols toggle win.position=left"
				end,
				filter = trouble_filter("left"),
			},
		},
		bottom = {
