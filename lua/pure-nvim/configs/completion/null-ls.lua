return function()
	...
	local function formatter_args(formatter_name)
		return require("completion.formatters." .. formatter_name)
	end
	...
	require("pure-nvim.utils").load_plugin("null-ls", {
		border = "rounded",
		debug = false,
		log_level = "warn",
		update_in_insert = false,
		sources = sources,
		default_timeout = require("pure-nvim.core.settings").format_timeout,
	})
