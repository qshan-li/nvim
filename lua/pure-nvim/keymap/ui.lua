...
local mappings = {
	builtins = {
		-- Builtins: Window split
		["n|<leader>/"] = map_cr("split"):with_noremap():with_silent():with_desc("window: Horizontal split"),
		["n|<leader>\\"] = map_cr("vsplit"):with_noremap():with_silent():with_desc("window: Vertical split"),
	...
	plugins = {
		...
		["n|<M-F12>h"] = map_cr("BufferLineCyclePrev"):with_noremap():with_silent():with_desc("buffer: Switch to prev"),
		["n|<M-F12>l"] = map_cr("BufferLineCycleNext"):with_noremap():with_silent():with_desc("buffer: Switch to next"),
